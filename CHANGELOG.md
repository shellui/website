...
- Publish a `/guidelines/` hub plus topic pages. Writing still renders markdown. Web design is a human rule list at `/guidelines/web-design/`; design is a visual handbook at `/guidelines/design/`. Agents fetch lean markdown (`/guidelines/web-design.md`, `/design.md`).
