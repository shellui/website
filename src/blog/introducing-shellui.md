...
lede: Shellui is an open-source web app development platform - a shared shell around your product so you ship the app, not the host chrome.
description: Announcing Shellui, an open-source microfrontend shell with auth, layouts, themes, and i18n. v0.3.0 is experimental and used on real projects.
date: 2026-08-19
author: Shellui
