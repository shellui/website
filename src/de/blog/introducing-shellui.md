...
title: Shellui vorgestellt | Shellui
heading: Shellui vorgestellt
lede: Shellui ist eine Open-Source-Web-App-Entwicklungsplattform – eine gemeinsame Shell um dein Produkt, damit du die App lieferst und nicht das Host-Chrome neu baust.
description: Ankündigung von Shellui, einer Open-Source-Mikrofrontend-Shell mit Auth, Layouts, Themen und i18n. v0.3.0 ist experimentell und wird für reale Projekte verwendet.
date: 2026-08-19
author: Shellui
authorRole: Das Shellui-Team
authorImage: /img/logo.png
category: Ankündigung
image: /img/blog/introducing-shellui.jpg
imageAlt: Person mit einem Hello-Aufkleber
tags:
  - blog
---
