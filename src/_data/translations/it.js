...
export default {
  ...
  "footer": {
    "tagline": "La piattaforma di sviluppo di app web.",
    "features": "Features",
  ...
  "siteDescription": "Shellui is the open-source web app development platform: a microfrontend shell with authentication, administration, storage, and shared UI.",
  "featurePages": [
    {
