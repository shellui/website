...
function ViewPicker({ viewId, onChange }) {
  return (
    <fieldset className="ag-picker">
      <legend className="ag-picker__legend">Flow</legend>
  ...
  const fit = useCallback(
    (animate = true) => {
      ...
      setViewport(
        {
          x: FIT_PADDING,
          y: Math.max(FIT_PADDING, (height - contentHeight * FIT_MIN_ZOOM) / 2),
          zoom: FIT_MIN_ZOOM,
        },
        options,
      );
  ...
  return (
    <div className="ag-root">
      ...
      <div className="ag-legend">
        <h3 className="ag-legend__title">Exchange in this view</h3>
        <ol className="ag-legend__list">
